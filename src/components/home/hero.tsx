...
const STATS = [
  { to: 2, suffix: " yrs", label: "Software validation & backend experience" },
  { to: 500, suffix: "+", label: "Algorithmic problems solved" },
  { to: 1900, suffix: "+", label: "LeetCode rating" },
];
...
/** Staggered hero — monogram, intro, magnetic CTAs, profiles, counters, marquee. */
export function Hero() {
  ...
  return (
    <>
      ...
      >
        <motion.div variants={reduce ? undefined : item} className="flex items-center gap-4">
          <Monogram initials="RB" />
